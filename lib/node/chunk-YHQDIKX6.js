...
var _FetchInterceptor = class extends _chunkDLID3GDGjs.Interceptor {
  ...
  async setup() {
    ...
    globalThis.fetch = async (input, init) => {
      ...
      const resolvedInput = typeof input === "string" && typeof location !== "undefined" && !_chunkDLID3GDGjs.canParseUrl.call(void 0, input) ? new URL(input, location.toString()) : input;
...
//# sourceMappingURL=chunk-YHQDIKX6.js.map