...
var _FetchInterceptor = class extends Interceptor {
  ...
  async setup() {
    ...
    globalThis.fetch = async (input, init) => {
      ...
      const resolvedInput = typeof input === "string" && typeof location !== "undefined" && !canParseUrl(input) ? new URL(input, location.toString()) : input;
...
//# sourceMappingURL=chunk-2MNUO4KL.mjs.map